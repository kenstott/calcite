...
public class SharePointDdlExecutor extends DdlExecutorImpl {
  ...
  private void createSharePointListGraph(SharePointListSchema schema, String listName,
    ...
    String createListUrl =
        String.format("%s/sites/%s/lists", client.getGraphApiBase(), client.getSiteId());
  ...
  private void createColumnGraph(MicrosoftGraphListClient client, String listId,
    ...
    String createColumnUrl =
        String.format("%s/sites/%s/lists/%s/columns", client.getGraphApiBase(), client.getSiteId(), listId);
  ...
  private void deleteSharePointListGraph(SharePointListSchema schema, String listName,
    ...
    // Delete the list
    String deleteUrl =
        String.format("%s/sites/%s/lists/%s", client.getGraphApiBase(), client.getSiteId(), listId);
