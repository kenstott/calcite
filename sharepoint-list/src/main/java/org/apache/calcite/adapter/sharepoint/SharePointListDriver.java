...
/**
 * JDBC driver for SharePoint Lists.
 *
 * <p>Accepts {@code jdbc:sharepoint:} URLs, parses semicolon-delimited parameters,
 * builds an inline Calcite model targeting {@link SharePointListSchemaFactory},
 * and delegates to the Calcite JDBC driver.
 *
 * <p>Example URL:
 * {@code jdbc:sharepoint:siteUrl=https://tenant.sharepoint.com/sites/mysite;authType=CLIENT_CREDENTIALS;clientId=...;clientSecret=...;tenantId=...}
 */
public class SharePointListDriver extends org.apache.calcite.jdbc.Driver {
    ...
    private String buildModel(Properties props) throws SQLException {
        try {
            ...
            throw new SQLException("Failed to build SharePoint model: " + e.getMessage(), e);
        }
    }
}
