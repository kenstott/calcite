...
SELECT 'nws_stations'            AS tbl, COUNT(*) AS rows FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/nws_stations', allow_moved_paths=true)
UNION ALL
SELECT 'nws_alerts',                     COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/nws_alerts', allow_moved_paths=true)
UNION ALL
SELECT 'cdo_stations',                   COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/cdo_stations', allow_moved_paths=true)
UNION ALL
SELECT 'cdo_monthly_summaries',          COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/cdo_monthly_summaries', allow_moved_paths=true)
UNION ALL
SELECT 'cdo_annual_summaries',           COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/cdo_annual_summaries', allow_moved_paths=true)
UNION ALL
SELECT 'epa_annual_aqi',                 COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/epa_annual_aqi', allow_moved_paths=true)
UNION ALL
SELECT 'ghcnd_stations_with_county',     COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/ghcnd_stations_with_county', allow_moved_paths=true)
UNION ALL
SELECT 'ghcnd_daily',                    COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/ghcnd_daily', allow_moved_paths=true)
UNION ALL
SELECT 'drought_monitor_weekly',         COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/drought_monitor_weekly', allow_moved_paths=true)
UNION ALL
SELECT 'hms_smoke_daily',                COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/hms_smoke_daily', allow_moved_paths=true)
UNION ALL
SELECT 'hms_smoke_polygons',             COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/hms_smoke_polygons', allow_moved_paths=true)
UNION ALL
SELECT 'climate_normals_monthly',        COUNT(*) FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/climate_normals_monthly', allow_moved_paths=true)
ORDER BY tbl;
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/hms_smoke_daily', allow_moved_paths=true)
GROUP BY year, month
ORDER BY year, month;
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/hms_smoke_polygons', allow_moved_paths=true)
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/nws_stations', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/drought_monitor_weekly', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/ghcnd_stations_with_county', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/ghcnd_daily', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/cdo_stations', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/epa_annual_aqi', allow_moved_paths=true);
...
FROM iceberg_scan('s3://govdata-parquet-v1/source=weather/WEATHER/climate_normals_monthly', allow_moved_paths=true);
