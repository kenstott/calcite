...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_ndc_products', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    ...
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_ndc_products', allow_moved_paths := true))
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_ndc_products', allow_moved_paths := true) WHERE product_ndc IS NULL);
...
FROM (SELECT COUNT(DISTINCT marketing_category) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_ndc_products', allow_moved_paths := true)
...
SELECT 'health', 'fda_drug_approvals', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_drug_approvals', allow_moved_paths := true));
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_drug_approvals', allow_moved_paths := true) WHERE application_number IS NULL);
...
SELECT 'health', 'fda_drug_recalls', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_drug_recalls', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_drug_recalls', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_drug_recalls', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_adverse_events', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_adverse_events', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_adverse_events', allow_moved_paths := true) WHERE safety_report_id IS NULL);
...
SELECT 'health', 'fda_device_recalls', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_device_recalls', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_device_recalls', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/fda_device_recalls', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
SELECT 'health', 'clinical_trials', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trials', allow_moved_paths := true));
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trials', allow_moved_paths := true) WHERE nct_id IS NULL);
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_conditions', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_conditions', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_conditions', allow_moved_paths := true)
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_interventions', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_interventions', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/clinical_trial_interventions', allow_moved_paths := true)
...
SELECT 'health', 'cdc_covid_vaccinations', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_covid_vaccinations', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_covid_vaccinations', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_covid_vaccinations', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(DISTINCT demographic_category) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_covid_vaccinations', allow_moved_paths := true)
...
SELECT 'health', 'cms_hospital_quality', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true) WHERE facility_id IS NULL);
...
FROM (SELECT COUNT(DISTINCT state) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true)
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_hospital_quality', allow_moved_paths := true)
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/medicaid_drug_utilization', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/medicaid_drug_utilization', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/medicaid_drug_utilization', allow_moved_paths := true)
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_mortality', allow_moved_paths := true)
...
FROM (SELECT COUNT(DISTINCT cause_name) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_mortality', allow_moved_paths := true)
...
SELECT 'health', 'cdc_brfss', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_brfss', allow_moved_paths := true));
...
FROM (SELECT COUNT(DISTINCT state) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cdc_brfss', allow_moved_paths := true)
      WHERE state IS NOT NULL);
...
SELECT 'health', 'cms_open_payments', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_open_payments', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_open_payments', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_open_payments', allow_moved_paths := true))
    WHERE null_percentage = 100.0
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_open_payments', allow_moved_paths := true)
...
FROM (SELECT COUNT(DISTINCT payment_type) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/cms_open_payments', allow_moved_paths := true));
...
SELECT 'health', 'rxnorm_drugs', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/rxnorm_drugs', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/rxnorm_drugs', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://govdata-parquet-v1/health/rxnorm_drugs', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS bad FROM iceberg_scan('s3://govdata-parquet-v1/health/rxnorm_drugs', allow_moved_paths := true)
...
FROM (SELECT COUNT(DISTINCT tty) AS n FROM iceberg_scan('s3://govdata-parquet-v1/health/rxnorm_drugs', allow_moved_paths := true)
