...
ALL_SCHEMAS="sec geo econ econ_reference census crime weather ref fec fedregister cyber_vuln cyber_threat health energy edu patents lands cftc disasters"
