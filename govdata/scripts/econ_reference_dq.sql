...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_industries', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_industries', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    ...
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_industries', allow_moved_paths := true))
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_industries', allow_moved_paths := true) WHERE industry_code IS NULL);
...
SELECT 'econ_reference', 'jolts_dataelements', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_dataelements', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_dataelements', allow_moved_paths := true) LIMIT 5;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_dataelements', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_dataelements', allow_moved_paths := true) WHERE dataelement_code IS NULL);
...
FROM (
  SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/jolts_dataelements', allow_moved_paths := true)
...
SELECT 'econ_reference', 'bls_geographies', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/bls_geographies', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/bls_geographies', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/bls_geographies', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/bls_geographies', allow_moved_paths := true) WHERE geo_code IS NULL);
...
SELECT 'econ_reference', 'naics_sectors', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/naics_sectors', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/naics_sectors', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/naics_sectors', allow_moved_paths := true))
    WHERE null_percentage = 100.0
      AND column_name NOT IN ('type')
  )
);
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/naics_sectors', allow_moved_paths := true) WHERE supersector_code IS NULL);
...
SELECT 'econ_reference', 'nipa_tables', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/nipa_tables', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/nipa_tables', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/nipa_tables', allow_moved_paths := true))
    WHERE null_percentage = 100.0
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/nipa_tables', allow_moved_paths := true) WHERE table_name IS NULL);
...
SELECT 'econ_reference', 'regional_linecodes', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/regional_linecodes', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/regional_linecodes', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/regional_linecodes', allow_moved_paths := true))
    WHERE null_percentage = 100.0
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/regional_linecodes', allow_moved_paths := true) WHERE key IS NULL);
...
FROM (
  ...
  FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/regional_linecodes', allow_moved_paths := true)
);
...
SELECT 'econ_reference', 'fred_series', 'T1_existence',
  CASE WHEN n > 0 THEN 'pass' ELSE 'fail' END,
  n, 1, 'Row count from iceberg_scan'
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/fred_series', allow_moved_paths := true));
...
-- T3: sample
SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/fred_series', allow_moved_paths := true) LIMIT 3;
...
FROM (
  ...
  FROM (
    SELECT column_name, null_percentage
    FROM (SUMMARIZE SELECT * FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/fred_series', allow_moved_paths := true))
    WHERE null_percentage = 100.0
...
FROM (SELECT COUNT(*) AS n FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/fred_series', allow_moved_paths := true) WHERE series IS NULL);
...
FROM (
  ...
  FROM iceberg_scan('s3://${GOVDATA_DQ_BUCKET}/econ_reference/fred_series', allow_moved_paths := true)
);
