#!/usr/bin/env bash
# Worker 57: SEC Compact-Only 2011 (all filing types)
set -euo pipefail
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-primary-2011.json" "$WORKER_ID"
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-secondary-2011.json" "$WORKER_ID"
