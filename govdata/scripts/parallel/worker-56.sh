#!/usr/bin/env bash
# Worker 56: SEC Compact-Only 2012 (all filing types)
set -euo pipefail
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-primary-2012.json" "$WORKER_ID"
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-secondary-2012.json" "$WORKER_ID"
