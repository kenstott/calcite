#!/usr/bin/env bash
# Worker 49: SEC Compact-Only 2019 (all filing types)
set -euo pipefail
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-primary-2019.json" "$WORKER_ID"
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-secondary-2019.json" "$WORKER_ID"
