#!/usr/bin/env bash
# Worker 44: SEC Compact-Only 2024 (all filing types)
set -euo pipefail
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-primary-2024.json" "$WORKER_ID"
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-secondary-2024.json" "$WORKER_ID"
