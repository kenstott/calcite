#!/usr/bin/env bash
# Worker 45: SEC Compact-Only 2023 (all filing types)
set -euo pipefail
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-primary-2023.json" "$WORKER_ID"
...
ETL_COMPACT_ONLY=true run_etl "$MODEL_DIR/sec-secondary-2023.json" "$WORKER_ID"
