...
public class NewGeoTablesDownloadTest {
  ...
  @Test public void testTigerDataDownloaderMethods() throws Exception {
  ...
  @Test public void testGeoSchemaWithNewTables() throws Exception {
    // Use temp directory for test data
    ...
    try (Connection connection =
      ...
      try (Statement stmt = connection.createStatement()) {
        ResultSet rs =
            stmt.executeQuery("SELECT table_name FROM metadata.tables "
  ...
  @Test public void testHivePartitionedStructure() throws Exception {
    // Use temp directory
  ...
  @Test public void testTableSchemaDefinitions() throws Exception {
