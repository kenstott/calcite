...
public class ComprehensiveGeoTableTest {
  ...
  @Test public void testTigerZctasTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      rs =
          stmt.executeQuery("SELECT zcta5, namelsad, population, housing_units "
  ...
  @Test public void testTigerCensusTractsTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      // Test that we can query specific columns
      rs =
          stmt.executeQuery("SELECT tract_geoid, namelsad, population, median_income "
  ...
  @Test public void testTigerBlockGroupsTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      // Test that we can query specific columns
      rs =
          stmt.executeQuery("SELECT bg_geoid, tract_code, blkgrp, population, housing_units "
  ...
  @Test public void testTigerCbsaTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      // Test that we can query specific columns
      rs =
          stmt.executeQuery("SELECT cbsa_code, cbsa_name, cbsa_type, population "
          + "FROM geo.tiger_cbsa "
  ...
  @Test public void testHudZipCbsaDivTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      // Test that we can query specific columns
      rs =
          stmt.executeQuery("SELECT zip, cbsadiv, cbsadiv_name, cbsa, cbsa_name, tot_ratio "
  ...
  @Test public void testHudZipCongressionalTable() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      // Test that we can query specific columns
      rs =
          stmt.executeQuery("SELECT zip, cd, cd_name, state_cd, state_code, state_name, tot_ratio "
  ...
  @Test public void testCrossTableJoins() throws Exception {
    ...
    try (Statement stmt = connection.createStatement()) {
      ...
      ResultSet rs =
          stmt.executeQuery("SELECT t.tract_geoid, t.namelsad as tract_name, "
  ...
  @Test public void testTableComments() throws Exception {
    System.out.println("\nTesting table comments...");

    try (Statement stmt = connection.createStatement()) {
      // Test that table comments are accessible
      ResultSet rs =
          stmt.executeQuery("SELECT table_name, table_comment "
  ...
  @Test public void testConstraintMetadata() throws Exception {
    System.out.println("\nTesting constraint metadata...");

    try (Statement stmt = connection.createStatement()) {
      // Test primary key constraints
      ResultSet rs =
          stmt.executeQuery("SELECT table_name, column_name, constraint_type "
  ...
  @Test public void testDataFileGeneration() throws Exception {
