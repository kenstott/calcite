...
public class GeoDataDownloadTest {
  ...
  @Test public void testTigerDataDownload() throws Exception {
  ...
  +
    ...
    try (Connection conn =
      ...
      TigerDataDownloader downloader =
          new TigerDataDownloader(new File(tempDir, "tiger-data"), 2024, true);
  ...
  @Test public void testCensusApiWithCredentials() throws Exception {
    String censusKey = System.getenv("CENSUS_API_KEY");
    ...
    CensusApiClient client =
        new CensusApiClient(censusKey,
    ...
    com.fasterxml.jackson.databind.JsonNode result =
        client.getAcsData(2022,  // Year (2022 = 2018-2022 5-year estimates)
  ...
  @Test public void testHudCrosswalkWithToken() throws Exception {
    String hudToken = System.getenv("HUD_TOKEN");
    ...
    HudCrosswalkFetcher fetcher =
        new HudCrosswalkFetcher(hudUsername,
        hudPassword,
        hudToken,
