...
**Returns:**
Description of return value, including possible null.

**Throws:**
| Exception | When |
|-----------|------|
| IllegalArgumentException | param1 is null or empty |
| IOException | Network request fails |

**Example:**
\`\`\`java
// Common use case
Result result = service.methodName("value", 42);

// Handling errors
try {
    Result result = service.methodName(input, count);
...
// Thread-safety: modifications protected by tableLock, but reads
