...
@Tag("integration")public class ParquetStatisticsIntegrationTest {
  ...
  @Test @DisplayName("HLL should be enabled by default for Parquet execution engine")
  ...
  @Test @DisplayName("Statistics should be generated with HLL for high-cardinality columns")
  ...
  @Test @DisplayName("Statistics should NOT contain HLL when disabled")
  ...
  @Test @DisplayName("ParquetTranslatableTable should implement StatisticsProvider with HLL")
  ...
  @Test @DisplayName("Query optimization should benefit from HLL statistics")
  ...
  @Test @DisplayName("Statistics cache should persist HLL data correctly")
  ...
  @Test @DisplayName("Statistics should be automatically used in query execution")
  ...
  @Test @DisplayName("Existing tests should exercise HLL functionality by default")
