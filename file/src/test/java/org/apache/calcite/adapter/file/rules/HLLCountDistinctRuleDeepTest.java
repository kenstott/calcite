...
/**
 * Deep unit tests for {@link HLLCountDistinctRule} covering the INSTANCE
 * singleton and Config interface.
 */
@Tag("unit")
public class HLLCountDistinctRuleDeepTest {
  ...
  @Test void testInstanceSameOnMultipleAccess() {
    HLLCountDistinctRule instance1 = HLLCountDistinctRule.INSTANCE;
    HLLCountDistinctRule instance2 = HLLCountDistinctRule.INSTANCE;
