...
public class EnvironmentVariableTest extends BaseFileTest {
  ...
  @Test public void testBasicSubstitution() {
  ...
  @Test public void testSubstitutionWithDefault() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testMissingVariableThrows() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testMultipleSubstitutions() {
    Map<String, String> env = new HashMap<>();
    env.put("VAR1", "value1");
    env.put("VAR2", "value2");
  ...
  @Test public void testJsonStringSubstitution() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testJsonNumberSubstitution() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testJsonBooleanSubstitution() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testComplexJsonModel() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testNestedDefaultValues() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testSpecialCharactersInValues() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testEmptyDefaultValue() {
    Map<String, String> env = new HashMap<>();
  ...
  @Test public void testContainsVariablesCheck() {
  ...
  @Test public void testIntegrationWithFileAdapter() throws Exception {
  ...
  @Test public void testExecutionEngineConfiguration() throws Exception {
  ...
  @Test public void testYamlStyleModel() {
