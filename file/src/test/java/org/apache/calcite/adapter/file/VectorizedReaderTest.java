...
@Tag("performance")public class VectorizedReaderTest {
  ...
  @Test void testBasicVectorizedReading() throws Exception {
  ...
  @Test void testBatchSizes() throws Exception {
    ...
    for (int batchSize : batchSizes) {
      VectorizedParquetReader reader =
          new VectorizedParquetReader(parquetFile.getAbsolutePath(), batchSize);
  ...
  @Test void testComparisonWithAvroReader() throws Exception {
  ...
  @Test void testPerformanceComparison() throws Exception {
