...
@Tag("integration")public class IcebergStorageProviderIntegrationTest {
  ...
  @Test public void testIcebergStorageProviderFromType() throws IOException {
  ...
  @Test public void testListNamespaces() throws IOException {
    Map<String, Object> config = new HashMap<>();
    config.put("catalogType", "hadoop");
    config.put("warehousePath", warehousePath);
  ...
  @Test public void testListTablesInNamespace() throws IOException {
    Map<String, Object> config = new HashMap<>();
    config.put("catalogType", "hadoop");
    config.put("warehousePath", warehousePath);
  ...
  @Test public void testDocumentedStorageTypePattern() throws IOException {
  ...
  @Test public void testPathResolution() throws IOException {
    Map<String, Object> config = new HashMap<>();
    config.put("catalogType", "hadoop");
    config.put("warehousePath", warehousePath);
  ...
  @Test public void testIcebergUrlScheme() throws IOException {
  ...
  @Test public void testEmptyStreamResponse() throws IOException {
  ...
  @Test public void testProviderCaching() {
