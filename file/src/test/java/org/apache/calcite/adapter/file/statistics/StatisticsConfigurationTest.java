...
public class StatisticsConfigurationTest {
  ...
  @Test @DisplayName("Default configuration should have HLL enabled by default")
  ...
  @Test @DisplayName("NO_HLL configuration should disable HLL")
  ...
  @Test @DisplayName("System properties should override default configuration")
  ...
  @Test @DisplayName("Builder should validate HLL precision boundaries")
  ...
  @Test @DisplayName("Statistics builder should respect HLL configuration")
  ...
  @Test @DisplayName("Effective configuration should prioritize system properties over environment")
  ...
  @Test @DisplayName("Configuration toString should provide useful information")
  ...
  @Test @DisplayName("Different configurations should produce different builders")
  ...
  @Test @DisplayName("Configuration should handle edge case values properly")
  ...
  @Test @DisplayName("Default builder should match default configuration")
