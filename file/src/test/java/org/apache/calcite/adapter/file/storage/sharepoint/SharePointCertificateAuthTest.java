...
public class SharePointCertificateAuthTest {
  ...
  @Test void testCertificateAuthentication() throws Exception {
  ...
  @Test void testCertificateWithNestedPath() throws Exception {
    if (certificatePath == null || certificatePassword == null) {
      System.out.println("Skipping test - certificate not configured");
      return;
    }
  ...
  @Test void testCertificateAuthWithCalcite() throws Exception {
    if (certificatePath == null || certificatePassword == null) {
      System.out.println("Skipping test - certificate not configured");
      return;
    }
