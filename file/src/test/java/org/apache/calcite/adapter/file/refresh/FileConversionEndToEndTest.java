...
public class FileConversionEndToEndTest {
  ...
  public void setupTestFiles() throws Exception {
    ...
    tempDir =
                       new File(System.getProperty("java.io.tmpdir"), "fileconv_test_" + System.nanoTime());
    tempDir.mkdirs();
    schemaDir = tempDir;
  ...
  @Test public void testExcelToJsonConversionWithMetadata() throws Exception {
  ...
  @Test public void testXmlToJsonConversionWithMetadata() throws Exception {
  ...
  @Test public void testDocxToJsonConversionWithMetadata() throws Exception {
  ...
  @Test public void testPptxToJsonConversionWithMetadata() throws Exception {
  ...
  @Test public void testMarkdownToJsonConversionWithMetadata() throws Exception {
  ...
  @Test public void testMultipleConversionsWithSharedMetadata() throws Exception {
  ...
  @Test public void testConversionCleanupAfterSourceDeletion() throws Exception {
