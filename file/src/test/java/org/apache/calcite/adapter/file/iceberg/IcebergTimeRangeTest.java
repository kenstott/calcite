...
public class IcebergTimeRangeTest {
  ...
  public void setUp() throws Exception {
    ...
    Schema salesSchema =
        new Schema(Types.NestedField.required(1, "sale_id", Types.IntegerType.get()),
  ...
  @Test public void testIcebergTimeRangeResolver() throws Exception {
  ...
  @Test public void testIcebergTimeRangeTable() throws Exception {
    ...
    IcebergTimeRangeTable timeRangeTable =
        new IcebergTimeRangeTable(dataFiles,
        "snapshot_time",
  ...
  @Test public void testTimeRangeIntegration() throws Exception {
