...
@Tag("unit")public class HyperLogLogSketchTest {
  ...
  @Test @DisplayName("HLL should provide accurate cardinality estimates for small datasets")
  ...
  @Test @DisplayName("HLL should provide accurate cardinality estimates for medium datasets")
  ...
  @Test @DisplayName("HLL should provide accurate cardinality estimates for large datasets")
  ...
  @Test @DisplayName("HLL should handle duplicate values correctly")
  ...
  @Test @DisplayName("HLL should handle null values gracefully")
  void testNullValues() {
    HyperLogLogSketch hll = new HyperLogLogSketch();
  ...
  @Test @DisplayName("HLL precision should affect accuracy and memory usage")
  ...
  @Test @DisplayName("HLL should support merging sketches")
  ...
  @Test @DisplayName("HLL should handle different data types correctly")
  ...
  @Test @DisplayName("HLL serialization should preserve sketch state")
  void testSerialization() {
    ...
    HyperLogLogSketch restored =
        new HyperLogLogSketch(original.getPrecision(),
        original.getBuckets());
  ...
  @Test @DisplayName("HLL should reject invalid precision values")
  ...
  @Test @DisplayName("HLL performance should be reasonable for large datasets")
