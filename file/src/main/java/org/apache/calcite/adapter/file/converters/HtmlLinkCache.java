...
public class HtmlLinkCache {
  ...
  private static class StringSource implements org.apache.calcite.util.Source {
    ...
    @Override public java.io.File file() {
      return null;
    }
    ...
    @Override public java.io.Reader reader() throws IOException {
    ...
    @Override public org.apache.calcite.util.Source relative(org.apache.calcite.util.Source source) {
      // For our simple use case, just return the source as-is
      return source;
    }

    @Override public org.apache.calcite.util.Source append(org.apache.calcite.util.Source child) {
      // For our simple use case, just return the child
      return child;
    }

    @Override public org.apache.calcite.util.Source trim(String suffix) {
      // For our simple use case, return this
      return this;
    }

    @Override public org.apache.calcite.util.@Nullable Source trimOrNull(String suffix) {
      // For our simple use case, return null
      return null;
    }

    @Override public java.util.Optional<java.io.File> fileOpt() {
