...
public class AperioDriver extends org.apache.calcite.jdbc.Driver {
    ...
    private Map<String, Object> buildOperand(String path, Properties info) {
        ...
        // Execution engine
        String engine = info.getProperty("executionEngine",
            System.getenv("APERIO_EXECUTION_ENGINE") != null
        ...
        if (storageType != null) {
            ...
            if ("s3".equalsIgnoreCase(storageType)) {
                ...
                String region = info.getProperty("s3Region",
                    System.getenv("AWS_REGION") != null ? System.getenv("AWS_REGION") : System.getenv("AWS_DEFAULT_REGION"));
                if (region != null) {
