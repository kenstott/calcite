...
public class EmbeddingProviderFactory {
  ...
  private static class PlaceholderEmbeddingProvider implements TextEmbeddingProvider {
    ...
    @Override public double[] generateEmbedding(String text) {
    ...
    @Override public java.util.List<double[]> generateEmbeddings(java.util.List<String> texts) {
    ...
    @Override public java.util.concurrent.CompletableFuture<double[]> generateEmbeddingAsync(String text) {
      return java.util.concurrent.CompletableFuture.completedFuture(generateEmbedding(text));
    }

    @Override public java.util.concurrent.CompletableFuture<java.util.List<double[]>> generateEmbeddingsAsync(java.util.List<String> texts) {
