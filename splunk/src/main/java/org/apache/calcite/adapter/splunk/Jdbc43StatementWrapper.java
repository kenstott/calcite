...
/**
 * Statement wrapper that wraps ResultSets with JDBC 4.3 compliant wrappers.
 */
public class Jdbc43StatementWrapper implements Statement {
  protected final Statement delegate;

  public Jdbc43StatementWrapper(Statement delegate) {
  ...
  @Override public ResultSet getResultSet() throws SQLException {
    ...
    return resultSet != null ? new Jdbc43ResultSetWrapper(resultSet) : null;
  }

  // All other methods delegate directly to the underlying Statement
