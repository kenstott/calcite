...
public class VectorMetadata {
  ...
  public static VectorMetadata parseFromComment(String columnName, String comment) {
    ...
    // Optional params: source_table_col, source_id_col, source_table
    ...
    // Detect pattern hints from metadata
    String sourceTableCol = matcher.group(4);
    String sourceIdCol = matcher.group(5);
    String sourceTable = matcher.group(6);

    if (sourceTableCol != null && sourceIdCol != null) {
      // Pattern 3: Multi-source
      vm.sourceTableColumn = sourceTableCol;
      vm.sourceIdColumnName = sourceIdCol;
    } else if (sourceTable != null && sourceIdCol != null) {
      // Pattern 2b: Logical FK
      vm.sourceTable = sourceTable;
      vm.sourceIdColumn = sourceIdCol;
    }
